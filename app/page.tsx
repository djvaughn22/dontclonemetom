...
function FindDogs() {
  ...
  // Load Petfinder's adoptable-pet widget script once; it upgrades the
  // <pet-scroller> element below into a live, dogs-only list.
  useEffect(() => {
    if (document.querySelector("script[data-pet-scroller]")) return;
